...
const theme = readFileSync(new URL('./EonscarTheme.css', import.meta.url), 'utf8');

describe('EONSCAR transmission visual isolation', () => {
  it('keeps home/loading key art out of in-world messages', () => {
    ...
    expect(backdropRule).not.toContain('eonscar-command-bg');
