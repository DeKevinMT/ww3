...
import { selectExpansionThreatSummaryV2 } from './warStrain';
...
describe('AI response to human Expansion Threat', () => {
  it('requires Suspicion before exploiting the same critical expansion opening', () => {
    ...
    expect(protectedDeclarations).toBe(0);
    expect(exposedDeclarations).toBeGreaterThan(0);
  }, 15_000);
