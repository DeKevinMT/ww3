...
describe('V2 legacy save migration', () => {
  ...
  it('authenticates v2.81-v2.82 and preserves every parallel research direction', () => {
    for (const legacyRulesVersion of [
      LEGACY_RULES_VERSION_V22_81,
      LEGACY_RULES_VERSION_V22_82,
    ]) {
      ...
      current.rulesVersion = legacyRulesVersion;
      current.canonicalStateHash = canonicalStateHashV2(current);
