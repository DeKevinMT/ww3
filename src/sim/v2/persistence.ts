...
const SAVE_KEYS = [
  'actionSequence', 'aiEscalation', 'canonicalStateHash', 'ceasefireObligations', 'contentVersion', 'humanPlayerId', 'mapId',
...
export function loadSaveV2(
  ...
  if (keys.length !== SAVE_KEYS.length || keys.some((key, index) => key !== SAVE_KEYS[index])) {
